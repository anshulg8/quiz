...
export const himymData: Question[] = [
  {
    question:
      "What is the name of the bar where the group frequently hangs out?",
    options: ["MacLaren's Pub", "Puzzles", "Central Perk", "The Drunken Clam"],
  ...
  },
  {
    ...
    options: ["Robin Sparkles", "Robin Daggers", "Jessica Glitter", "Tiffany"],
    answer: "Robin Sparkles",
  },
  {
    question:
      "Which character is obsessed with finding the best burger in New York?",
    options: ["Marshall Eriksen", "Ted Mosby", "Barney Stinson", "Lily Aldrin"],
