...
export const rnmData: Question[] = [
  {
    question: "What is the name of Rick's portal gun invention?",
    options: ["Portal Gun", "Time Gun", "Dimension Blaster", "Wormhole Device"],
    answer: "Portal Gun",
  },
  {
  ...
  },
  {
    ...
    options: ["Solve problems", "Fix portals", "Rule dimensions", "Cook meals"],
